    ...
    <>
      <div className='bg-[#000000] w-screen h-screen flex'>
        <div className='w-[50%] h-full p-[10px] pt-10 flex flex-col items-center'>
            <img className='w-[22rem] h-[17rem] mt-2 rounded-[45px] border-yellow-ochre border-[10px] mx-auto ' src={koruslogo}></img>
            ...
            <div className='h-[5rem] rounded-[14px] w-[377px] bg-yellow-ochre mx-auto mt-[20px] flex justify-center items-center text-[2rem] text-[#ffffff] font-[400] '>book your slot</div>
        </div>
